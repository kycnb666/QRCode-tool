...
namespace QRcode
{
    public partial class Form1 : Form
    {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            toolTip2.SetToolTip(button5, "已复制！");
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            {
                File.Delete($"{Path.GetTempPath()}qrcode.png");
            }
            if (File.Exists($"{Path.GetTempPath()}jietu.png"))
            {
                File.Delete($"{Path.GetTempPath()}jietu.png");
        ...
        private void pictureBox1_Click(object sender, EventArgs e)
        {
            if (pictureBox1.Image != null)
            {
                ...
                toolTip2.SetToolTip(pictureBox1, "已复制！");
                Thread.Sleep(1000);
                toolTip2.SetToolTip(pictureBox1, "单击图片可直接复制");
            }
            else
            {
                toolTip2.SetToolTip(pictureBox1, "没有图片可以复制");
            }
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            if (pictureBox2.Image != null)
            {
                ...
                toolTip2.SetToolTip(pictureBox2, "已复制！");
                Thread.Sleep(1000);
                toolTip2.SetToolTip(pictureBox2, "单击图片可直接复制");
            }
            else
            {
